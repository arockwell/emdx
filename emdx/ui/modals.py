...
class TagEditModal(ModalScreen):
    ...
    Args:
        doc_ids: List of document IDs to modify
        doc_titles: List of corresponding document titles (for display)
        mode: "add" or "remove"
        current_tags: List of current tags (for remove mode display)
    """
