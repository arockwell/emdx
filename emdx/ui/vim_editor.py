...
class VimEditor(Vertical):
    ...
    def on_mount(self):
        ...
        # Add subtle right border to line numbers (uses theme surface color)
        self.line_numbers.styles.border_right = ("solid", "$surface")
    ...
    def _initialize_editor(self):
        ...
        try:
            ...
            total_lines_count = len(self.text_area.text.split('\n'))
            self.line_numbers.set_line_numbers(current_line, total_lines_count, self.text_area)
