...
class SearchScreen(HelpMixin, Widget):
    ...
    def _update_mode_buttons(self, mode: SearchMode) -> None:
        ...
        for m, btn_id in mode_map.items():
            try:
                ...
                logger.debug(f"Failed to update mode button state: {e}")
    ...
    def _format_time(self, time_str: str) -> str:
        ...
        try:
            ...
            logger.debug(f"Time formatting failed: {e}")
            return ""
    ...
    def on_input_changed(self, event: Input.Changed) -> None:
        ...
        if self._debounce_timer:
            try:
                ...
                logger.debug(f"Timer stop failed: {e}")
            self._debounce_timer = None
    ...
    def on_key(self, event) -> None:
        ...
        try:
            ...
            logger.debug(f"Key event handling check failed: {e}")
