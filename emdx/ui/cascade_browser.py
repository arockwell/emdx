...
class CascadeView(Widget):
    ...
    def refresh_all(self) -> None:
        ...
        if not self.processing_doc_id:
            self._update_status("[green]●[/green] Auto-refresh │ [dim]h/l[/dim] stages │ [dim]j/k[/dim] docs │ [dim]a[/dim] advance │ [dim]p[/dim] process │ [dim]d[/dim] diagnose │ [dim]s[/dim] synthesize")
