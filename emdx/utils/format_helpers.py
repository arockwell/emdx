...
def extract_line_context(content: str, line_num: int, context_lines: int = 2) -> list[tuple[int, str, bool]]:
...
def suggest_fixes(content: str, rule: str) -> Optional[str]:
    ...
    suggestions = {
        ...
        "line-too-long": "Break long lines at logical points (e.g., after commas, before conjunctions)",
