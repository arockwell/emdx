#!/usr/bin/env python3
"""
Enhanced textual browser using MarkdownViewer for better rendering.
"""

from textual.app import App, ComposeResult
from textual.widgets import Header, Footer, DataTable, Input, Label, MarkdownViewer
...
class DocumentBrowser(App):
    """Modal document browser with native markdown rendering."""
...
{doc['content']}"""
                ...
                preview.document.update(markdown_content)
                preview.scroll_home(animate=False)
        except Exception as e:
            preview = self.query_one("#preview", MarkdownViewer)
            preview.document.update(f"# Error\n\nError loading preview: {e}")
