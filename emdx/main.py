...
from emdx.commands.graph import app as graph_app
...
# Add graph as a subcommand group
app.add_typer(graph_app, name="graph", help="Analyze and visualize knowledge graphs")
