...
LAZY_HELP = {
    ...
    "each": "[Deprecated: use delegate] Reusable parallel commands",
    "run": "[Deprecated: use delegate] Quick task execution",
    "agent": "[Deprecated: use delegate] Run Claude sub-agent",
