...
def _output_text(project: Optional[str], verbose: bool, quiet: bool, markdown: bool, execution: bool, smart: bool = False):
...
def _output_json(project: Optional[str], verbose: bool, quiet: bool, execution: bool, smart: bool = False):
