...
def find(
    ...
    mode: Optional[str] = typer.Option(
        None, "--mode", "-m",
        help="Search mode: keyword (FTS5), semantic (embeddings), hybrid (both, default if index exists)"
    ),
...
def _find_keyword_search(
    search_query: str, project: Optional[str], limit: int, snippets: bool,
    fuzzy: bool, tags: Optional[str], any_tags: bool, no_tags: Optional[str],
    ids_only: bool, json_output: bool, created_after: Optional[str],
    created_before: Optional[str], modified_after: Optional[str],
