...
from textual.widgets import DataTable, Input, Label, RichLog, Button
...
{doc['content']}"""
    ...
    def action_edit(self):
        ...
        try:
            ...
            temp_file = tempfile.NamedTemporaryFile(
                ...
                prefix=f"emdx_doc_{self.current_doc_id}_"
            )
            ...
            temp_file.write(f"# Lines starting with '#' will be removed\n")
            temp_file.write("#\n")
    ...
    def action_view(self):
        ...
        from emdx.textual_browser import FullScreenView
