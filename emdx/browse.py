...
def list(
    ...
    try:
        ...
        if format == "table":
            ...
            title = f"Knowledge Base Documents"
            if project:
            ...
            for doc in docs:
                ...
                console.print(f"{doc['id']},{title},{doc['project'] or ''},{doc['created_at'].strftime('%Y-%m-%d')},{doc['access_count']}")
...
@app.command()
def stats(
    project: Optional[str] = typer.Option(None, "--project", "-p", help="Show stats for specific project"),
