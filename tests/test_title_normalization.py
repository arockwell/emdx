...
class TestNormalizeTitle:
    ...
    def test_removes_version_in_parens(self) -> None:
        result = normalize_title("Design Doc (v3)")
        assert result == "Design Doc"

    def test_removes_version_case_insensitive(self) -> None:
    ...
    def test_removes_error_case_insensitive(self) -> None:
    ...
    def test_only_date_returns_empty_or_minimal(self) -> None:
