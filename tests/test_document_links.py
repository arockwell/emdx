...
class TestMigration043:
    ...
    def test_creates_indexes(self):
        ...
        cursor = conn.execute(
            "SELECT COUNT(*) FROM sqlite_master WHERE type='index' AND name LIKE 'idx_doc_links_%'"
        )
...
class TestLinkService:
    ...
    def test_auto_link_no_index(self, MockEmbedding, mock_links, isolate_test_database):
    ...
    @patch("emdx.services.link_service.document_links")
    @patch("emdx.services.embedding_service.EmbeddingService")
    def test_auto_link_creates_links(self, MockEmbedding, mock_links, isolate_test_database):
    ...
    @patch("emdx.services.link_service.document_links")
    @patch("emdx.services.embedding_service.EmbeddingService")
    def test_auto_link_skips_existing(self, MockEmbedding, mock_links, isolate_test_database):
